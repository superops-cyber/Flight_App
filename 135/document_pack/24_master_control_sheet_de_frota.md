# Master Control Sheet de frota

**Categoria:** Aeronave  
**Prioridade:** Alta  
**Responsável sugerido:** DOPS  
**Fonte (manuais):** MGM 1.11

## Ficha de controle

| Campo | Preenchimento |
|---|---|
| Documento | Master Control Sheet de frota |
| Categoria | Aeronave |
| Prioridade | Alta |
| Responsável primário | DOPS |
| Fonte (manuais) | MGM 1.11 |
...
| Item | Conteúdo |
|---|---|
| Finalidade | Planilha mestra de entrada/saída e status técnico-operacional da frota. |
| Exemplo de preenchimento | PT-XXX: entrada aprovada em 2026-02-10, status em serviço. |
