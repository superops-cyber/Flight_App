...
**Fonte (manuais):** MGO 1.4, MGO 2.6, SOP 1.6.1

## Ficha de controle

| Campo | Preenchimento |
|---|---|
| Documento | Cadastro de tripulantes |
| Categoria | Operações |
| Prioridade | Alta |
...
| Item | Conteúdo |
|---|---|
| Finalidade | Cadastro ativo com função, vínculo e elegibilidade operacional. |
| Exemplo de preenchimento | PIC: Carlos Lima, CANAC 123456, status apto, base SWNS. |
